...
( function( $, api ) {
    ...
    api.controlConstructor['dreamy-portfolio-repeater-text'] = api.Control.extend({
        ...
        // upsell 
    api.sectionConstructor['dreamy-portfolio-upsell'] = api.Section.extend( {
...
*/
 jQuery(document).ready(function($) {
    // $('#dreamy-portfolio-img-container li label img').click(function(){       
    //     $('#dreamy-portfolio-img-container li').each(function(){
    //         $(this).find('img').removeClass ('dreamy-portfolio-radio-img-selected') ;
    //     });
    //     $(this).addClass ('dreamy-portfolio-radio-img-selected') ;
    // }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', dreamy_portfolio_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', dreamy_portfolio_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', dreamy_portfolio_customize_multi_remove_field )
    ...
    $('#customize-control-theme_options-layout_options_blog #dreamy-portfolio-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #dreamy-portfolio-img-container li').each(function(){
            $(this).find('img').removeClass ('dreamy-portfolio-radio-img-selected') ;
        });
        $(this).addClass ('dreamy-portfolio-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #dreamy-portfolio-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #dreamy-portfolio-img-container li').each(function(){
            $(this).find('img').removeClass ('dreamy-portfolio-radio-img-selected') ;
        });
        $(this).addClass ('dreamy-portfolio-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #dreamy-portfolio-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #dreamy-portfolio-img-container li').each(function(){
            $(this).find('img').removeClass ('dreamy-portfolio-radio-img-selected') ;
        });
        $(this).addClass ('dreamy-portfolio-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #dreamy-portfolio-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #dreamy-portfolio-img-container li').each(function(){
            $(this).find('img').removeClass ('dreamy-portfolio-radio-img-selected') ;
        });
        $(this).addClass ('dreamy-portfolio-radio-img-selected') ;
    });    

    function dreamy_portfolio_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            dreamy_portfolio_customize_multi_write( $control );
    }

    function dreamy_portfolio_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        dreamy_portfolio_customize_multi_write( $control );
    }

    function dreamy_portfolio_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function dreamy_portfolio_customize_multi_write( $element) {
