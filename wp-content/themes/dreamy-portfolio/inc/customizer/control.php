...
class Dreamy_Portfolio_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="dreamy-portfolio-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class Dreamy_Portfolio_Dropdown_Multiple_Chooser extends WP_Customize_Control{
    ...
    public function render_content(){
        ...
        ?>
            <label>
                ...
                <select class="dreamy-portfolio-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
...
Class Dreamy_Portfolio_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class Dreamy_Portfolio_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class Dreamy_Portfolio_Note_Control extends WP_Customize_Control {
