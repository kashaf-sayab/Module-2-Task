 ...
 */
get_header(); 
$latest_post_column = dreamy_portfolio_get_option( 'number_of_latest_posts_column' );
$latest_section_posts_title = dreamy_portfolio_get_option( 'latest_section_posts_title' );
	...
	<div class="wrapper page-section">
		...
		<div id="primary" class="content-area">
			<main id="main" class="site-main blog-posts-wrapper" role="main">
				...
				<?php 	/**
			* Hook - dreamy_portfolio_pagination_action.
			*
			* @hooked dreamy_portfolio_pagination 
			*/
			 do_action('dreamy_portfolio_pagination_action');?>
			</main><!-- #main -->
		</div><!-- #primary -->
