...
?>
<?php 
	$enable_category     = dreamy_portfolio_get_option( 'latest_category_enable' );
	$enable_author     = dreamy_portfolio_get_option( 'latest_author_enable' );
	$enable_comment     = dreamy_portfolio_get_option( 'latest_comment_enable' );
	$enable_read_more_text     = dreamy_portfolio_get_option( 'latest_read_more_text_enable' );
    $enable_posted_on     = dreamy_portfolio_get_option( 'latest_posted_on_enable' );
    $enable_video = dreamy_portfolio_get_option( 'latest_video_enable' );
    $header_font_size = dreamy_portfolio_get_option( 'latest_font_size');
	$latest_readmore_text = dreamy_portfolio_get_option( 'latest_readmore_text' );
