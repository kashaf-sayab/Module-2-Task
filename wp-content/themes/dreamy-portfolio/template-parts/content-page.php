...
?>
<?php 
$enable_video = dreamy_portfolio_get_option( 'single_page_video_enable' );
$enable_image = dreamy_portfolio_get_option( 'single_page_image_enable' );
$enable_header_image     = dreamy_portfolio_get_option( 'single_page_header_image_enable' ); ?>
