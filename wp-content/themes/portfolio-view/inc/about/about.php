	...
	<div class="mgadin-hero">
		<div class="mge-info-content">
			...
			<div class="mge-info-desc">
				...
				<div><?php printf(esc_html__('Hi Buddy!! Now You are using the Free version of %s theme.', 'portfolio-view'), $current_theme_name); ?></div>
				<div><?php esc_html_e('The Portfolio View PRO version offers advanced features and an auto-setup feature for ease of use. By activating the theme and following the auto-setup instructions, users can quickly and easily create a professional-looking website with just a few clicks. It is recommended to upgrade to the PRO version to take advantage of these additional features.', 'portfolio-view'); ?></div>
				<div class="mge-offer"><?php esc_html_e('Unlock advanced features and take your website to the next level. Upgrade to our Pro version today!! ', 'portfolio-view'); ?></div>
			</div>
