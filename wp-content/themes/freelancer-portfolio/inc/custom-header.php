...
function freelancerportfolio_header_style() {
	...
	<style type="text/css">
		...
		#service-section .single-service img {
			height: <?php echo esc_attr(get_theme_mod('freelancer_portfolio_Service_image_height')); ?>px !important;
		}
		...
		.blog-area .blog-image img {
			height: <?php echo esc_attr(get_theme_mod('freelancer_portfolio_blog_image_height')); ?>px !important;
		}
